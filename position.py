...
"""
entered_list=[]
def searchIndice(text):
    global entered_list
    if text in entered_list:
        print ("Position of the searched string is:", entered_list.index(text))
    else:
        print("No such string found in the list")

n= int(input("enter number:"))

for i in range(n):
   user_ip= input()
   entered_list.append(user_ip)

search_str=input("Enter the string to be searched:") 

searchIndice(search_str)